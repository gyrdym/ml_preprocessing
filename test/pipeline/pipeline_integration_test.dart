...
import 'package:ml_preprocessing/src/encoder/to_integer_labels.dart';
import 'package:ml_preprocessing/src/encoder/to_one_hot_labels.dart';
...
void main() {
  group('Pipeline', () {
    test(
        'should process steps, which return dataframes of different series '
        'number', () {
      ...
      final pipeline = Pipeline(fittingData, [
        toOneHotLabels(columnIndices: [1]),
        toOneHotLabels(columnIndices: [2, 3]),
        toIntegerLabels(columnNames: ['first']),
      ]);
    ...
    test('should not rewrite previously encoded series', () {
      ...
      final pipeline = Pipeline(fittingData, [
        toOneHotLabels(columnIndices: [1, 2]),
        toIntegerLabels(columnIndices: [0, 1, 3]),
      ]);
