...
void main() {
  group('Float32x4InterceptPreprocessorInternal', () {
    test('should add intercept to the given points', () {
      final preprocessor = Float32x4InterceptPreprocessorInternal(interceptScale: 1.0);
    ...
    test('should return the same test_data if scale is 0.0 (processing does nnot take place)', () {
      ...
      final preprocessor = Float32x4InterceptPreprocessorInternal(interceptScale: 0.0);
      final processedPoints = preprocessor.addIntercept(data);
    ...
    test('should consider scale parameter (if scale is not equal to 0.0)', () {
      ...
      final preprocessor = Float32x4InterceptPreprocessorInternal(interceptScale: -5.0);
      final processedPoints = preprocessor.addIntercept(data);
