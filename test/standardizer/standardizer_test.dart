...
void main() {
  ...
  group('Standardizer', () {
    test(
        'should extract deviation and mean values from fitting data and apply '
    ...
    test(
        'should throw an exception if one tries to apply standardizer to a '
    ...
    test(
        'should throw an exception if one tries to create a standardizer '
